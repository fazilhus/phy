...
namespace Render {
    ...
    private:
        ...
        static TextureResource* Instance() { return instance; }
    ...
    public:
        ...
        static TextureResourceId LoadTexture(
            const char* path, MagFilter mag, MinFilter min, WrappingMode wrapModeS, WrappingMode wrapModeT, bool sRGB
        );
        static TextureResourceId LoadTextureFromMemory(
            std::string name, void* buffer, uint64_t bytes, ImageId imageId, MagFilter, MinFilter, WrappingMode,
