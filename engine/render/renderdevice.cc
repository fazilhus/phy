...
*/
    ...
    /**
*/
    void RenderDevice::StaticGeometryPrepass() {
    ...
    /**
*/
    void RenderDevice::LightCullingPass() {
    ...
    /**
*/
    void RenderDevice::StaticForwardPass() {
        glBindFramebuffer(GL_FRAMEBUFFER, Instance()->forwardFrameBuffer);
...
*/
    ...
    /**
*/
    void RenderDevice::ParticlePass(float dt) {
    ...
    void Render::RenderDevice::FinalizePass(Display::Window* wnd) {
        int w, h;
        wnd->GetSize(w, h);
        glViewport(0, 0, w, h);
...
*/
    void RenderDevice::Render(Display::Window* wnd, float dt) {
        ...
        if (Instance()->skybox != InvalidResourceId) { Instance()->SkyboxPass(); }
