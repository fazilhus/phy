...
*/
        void Initialize() {
            ...
            glTexImage2D(
                GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, shadowMapSize, shadowMapSize, 0, GL_DEPTH_COMPONENT, GL_FLOAT, 0
            );
...
*/
        void UpdateWorkGroups(uint resolutionWidth, uint resolutionHeight) {
            ...
            glBufferData(
                GL_SHADER_STORAGE_BUFFER, numberOfTiles * sizeof(VisibleIndex) * maxTileLights, 0, GL_DYNAMIC_DRAW
            );
...
*/
        ...
        /**
*/
        bool IsValid(PointLightId id) { return pointLightPool.IsValid(id); }
