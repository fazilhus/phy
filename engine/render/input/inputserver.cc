...
*/
    ...
    /**
*/
    void InputHandler::HandleKeyEvent(int32 key, int32 scancode, int32 action, int32 mods) {
    ...
    /**
*/
    void InputHandler::HandleMousePressEvent(int32 button, int32 action, int32 mods) {
